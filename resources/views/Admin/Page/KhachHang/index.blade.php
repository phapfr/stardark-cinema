                            ...
                            <tbody>
                                <tr v-for="(value, key) in list">
                                    ...
                                    <td class="text-nowrap text-center align-middle">
                                        ...
                                        <button v-on:click="changeStatus(value.id)" class="btn btn-success" v-else>Đang
                                            Mở</button>
                                    </td>
                                    <td class="text-nowrap text-center align-middle">
                                        <button v-on:click="kichHoat(value.id)" class="btn btn-warning"
                                            v-if="value.loai_tai_khoan == 1">Hủy Kích Hoạt</button>
                                        <button v-on:click="kichHoat(value.id)" class="btn btn-info" v-else>Kích
                                            Hoạt</button>
                                    </td>
                                    <td class="text-nowrap text-center align-middle">
                                        <button v-on:click="password_new = value" class="btn btn-success"
                                            data-bs-toggle="modal" data-bs-target="#doiMatKhau">Đổi Mật Khẩu</button>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="password" v-model="password_new.password" name="password"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
