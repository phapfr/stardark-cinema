            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Thêm Mới Phòng</h1>
                            ...
                            <tbody>
                                <tr v-for="(value, key) in ds_phim">
                                    ...
                                    <td class="align-middle text-nowrap">
                                        <a v-bind:href="value.trailer" target="_blank" class="btn btn-primary">Link
                                            Video</a>
                                    </td>
                                    <td class="align-middle text-nowrap">
                                    ...
                                    <td class="align-middle text-nowrap">
                                        <a v-on:click="showUpdate(value)" data-bs-toggle="modal"
                                            data-bs-target="#updateModal" class="btn-cta"><i
                                                class="fa-regular fa-pen-to-square">Cập Nhật</i></a>
                                        <a v-on:click="phim_xoa = value" class="btn-cta" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal"><i class="fa-solid fa-trash-can">Xóa
                                                Phim</i></a>
                                    </td>
                                </tr>
                            </tbody>
