            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="button" v-on:click="createPhong()">Thêm Mới Phòng</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6"><b class="fs-4">Danh Sách Các Phòng</b></div>
                            ...
                            <tbody>
                                <tr v-for="(value, key) in ds_phong">
                                    ...
                                    <td class="align-middle text-center text-nowrap">
                                        ...
                                        <button v-on:click="changeStatus(value.id)" class="btn btn-primary" v-else>Đang Kinh
                                            Doanh</button>
                                    </td>
                                    ...
                                    <td class="align-middle text-center text-nowrap">
                                        ...
                                        <button v-on:click="phong_update = value" data-bs-toggle="modal"
                                            ...
                                            Nhật</button>
                                        <button v-on:click="delete_phong = value" class="btn btn-danger"
                                            data-bs-toggle="modal" data-bs-target="#deleteModal">Xóa Phòng</button>
                                    </td>
                                </tr>
                            </tbody>
                            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Việc này sẽ xóa cả phòng và ghế của phòng</p>
                                            <p><b>Lưu ý:</b> Không thể hoàn tác!</p>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group mt-1">
                                                ...
                                                <input v-model="phong_update.ten_phong" type="text"
                                                    class="form-control" placeholder="Nhập vào tên phòng">
                                            </div>
                                            <div class="form-group mt-3">
                                                <label>Tình Trạng</label>
                                                <select v-model="phong_update.tinh_trang" class="form-control">
                                                    <option v-bind:value="1">Đang kinh doanh</option>
                        ...
                        <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <table class="table table-bordered" style="border-collapse: separate" id="table_ghe">
                                        <thead>
                                ...
                                for (i = 0; i < hang_doc; i++) {
                                    ...
                                    if (list_ghe[x].tinh_trang) {
                                        noi_dung += '<th data-id="' + list_ghe[x].id +
                                            '" class="change text-center aligin-middle" style="height: 50px; font-size: 16px; background-color: #DEF5E5">' +
                                            list_ghe[x].ten_ghe + '</th>';
                                    } else {
                                        noi_dung += '<th data-id="' + list_ghe[x].id +
                                            '" class="change text-center aligin-middle" style="height: 50px; font-size: 16px; background-color: red">' +
                                            list_ghe[x].ten_ghe + '</th>';
                                    }
                                }
                                noi_dung += '</tr>';
