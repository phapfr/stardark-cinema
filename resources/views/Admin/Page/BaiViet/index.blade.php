            ...
            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="button" v-on:click="createBaiViet()">Thêm Mới Bài
                            Viết</button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card border-primary border-bottom border-3 border-0">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6"><b class="fs-4">Danh Sách Bài Viết</b></div>
                        <div class="col-md-6 text-end"><button type="button" class="btn btn-primary w-5"
                                data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-plus"></i>
                                Thêm mới bài viết
                            </button></div>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="text-center align-middle bg-primary text-white text-nowrap">
                                    ...
                                    <th class="text-center">Nội Dung Chính</th>
                            ...
                            <tbody>
                                <tr v-for="(value, key) in list_bai_viet">
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <button class="btn btn-info" v-on:click="mo_ta_ngan = value.mo_ta_ngan"
                                            data-bs-toggle="modal" data-bs-target="#motanganModal">Mô tả ngắn</button>
                                    </td>
                                    <td class="text-center align-middle text-nowrap">
                                        <button class="btn btn-info" v-on:click="noi_dung = value.noi_dung"
                                            data-bs-toggle="modal" data-bs-target="#noidungModal">Nội dung</button>
                                    </td>
                                    <td class="text-nowrap align-middle text-center">
                                        <button v-on:click="doiTrangThai(value.id)" v-if="value.is_open == 1"
                                            class="btn btn-success">Hiển thị</button>
                                        <button v-on:click="doiTrangThai(value.id)" v-else class="btn btn-danger">Tạm
                                            tắt</button>
                                    </td>
                                    <td class="text-nowrap align-middle text-center">
                                        <button v-on:click="editBaiViet(edit = value)" data-bs-toggle="modal"
                                            data-bs-target="#editModal" class="btn btn-primary">Cập nhật</button>
                                        <button v-on:click="deleteBV = value" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                <div class="modal-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-prepend">
                                                        <a id="lfm_edit" data-input="hinh_anh_edit"
                                                            data-preview="holder_edit" class="btn btn-primary">
                                                            <i class="fa fa-picture-o"></i> Choose
                                                        </a>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" v-on:click="updateBaiViet()">Cập
                                            nhật</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Đóng</button>
                                        <button type="button" v-on:click="deleteBaiViet()"
