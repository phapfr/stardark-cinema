        ...
        <tr style="border-collapse:collapse">
            <td valign="top" style="padding:0;Margin:0">
                <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color: grey;background-repeat:repeat;background-position:center top">
                    <tr style="border-collapse:collapse">
                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                    ...
                    <tr style="border-collapse:collapse">
                        <td style="padding:0;Margin:0;background-color:grey" bgcolor=" grey" align="center">
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                                                ...
                                                                <p
                                                                    ...
                                                                    Chào mừng bạn, <strong>{{ $data['ho_va_ten'] }}
                                                                    </strong>đã đến với website của chúng tôi. Chúng tôi
                                                                    vui mừng khi bạn đã đăng ký tài khoản.<br>Để thực
                                                                    hiện việc kích hoạt tài khoản vui lòng bấm vào liên
                                                                    kết dưới đây.</p>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <span class="es-button-border"
                                                                    style="border-style:solid;border-color: grey;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                                                        href="{{ env('APP_URL') }}/active/{{ $data['hash_mail'] }}"
                                                                        class="es-button es-button-1" target="_blank"
                                                                        style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color: grey;border-width:15px 30px;display:inline-block;background: grey;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">Kích
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-l" align="left"
                                                                ...
                                                                <p
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                    Trong trường hợp liên kết không hoạt động, bạn có
                                                                    thể copy đường liên kết dưới đây và dán vào trình
                                                                    duyệt</p>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-l" align="left"
                                                                ...
                                                                <a target="_blank"
                                                                    href="{{ env('APP_URL') }}/active/{{ $data['hash_mail'] }}"
                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color: grey;font-size:18px">{{ env('APP_URL') }}/active/{{ $data['hash_mail'] }}</a>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td class="es-m-txt-l" align="left"
                                                                ...
                                                                <p
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                    Nếu bạn có bất kỳ câu hỏi nào khác, có thể liên hệ
                                                                    qua email của chúng tôi ở đây:
                                                                    <em><strong>stardarkcinema@gmail.com</strong></em><br><em>Đây
                                                                        là email tự động vui lòng không reply lại email
                                                                        này</em>
                                                                </p>
                                                            </td>
                                                        </tr>
