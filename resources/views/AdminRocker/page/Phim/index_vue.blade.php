                                ...
                                <div class="card-body">
                                    <form id="createPhimForm">
                                        <div class="form-group mt-1">
                                            ...
                                            <input v-on:keyup="chuyenThangTenPhimSangSlug()" v-model="them_moi.ten_phim"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input v-model="them_moi.ngay_khoi_chieu" type="date" class="form-control"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input v-model="them_moi.the_loai" type="text" class="form-control"
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6"><b class="fs-4">Danh Sách Phim</b></div>
                        <div class="col-md-6 text-end"><button type="button" class="btn btn-primary w-5" data-bs-toggle="modal"
                        ...
                        <table class="table table-bordered" id="table_phim">
                            ...
                            <tbody>
                                <tr v-for="(value, key) in ds_phim">
                                    ...
                                    <td class="align-middle" v-html="value.dien_vien.substring(0, 50)+ '...'"></td>
                                    <td class="align-middle">@{{ value.thoi_luong }}</td>
                                    <td class="align-middle" v-html="value.mo_ta.substring(0, 50)+ '...'"></td>
                                    <td class="align-middle">@{{ value.the_loai }}</td>
                                    <td class="align-middle">
                                        <button class="btn btn-light" v-on:click="phim_xoa = value"
                                            data-bs-toggle="modal" data-bs-target="#hinhAnhModel"><i
                                                class="fa-solid fa-image text-dark"></i></button>
                                        {{-- <img v-bind:src="value.avatar" class="img-fluid" style="max-width: 200px;"> --}}
                                    </td>
                                    <td class="align-middle text-nowrap">
                                        <a v-bind:href="value.trailer" target="_blank" class="text-danger">Link
                                            trailer</a>
                                    </td>
                                    <td class="text-center align-middle text-nowrap">
                                        <button class="btn btn-warning" v-if="value.tinh_trang == 0">Ngưng Chiếu</button>
                                        <button class="btn btn-success" v-if="value.tinh_trang == 1">Đang Chiếu</button>
                                        <button class="btn btn-primary" v-if="value.tinh_trang == 2">Sắp Chiếu</button>
                                    </td>
                                    <td class="align-middle text-nowrap">
                                        <button v-on:click="showUpdate(value)" data-bs-toggle="modal"
                                            data-bs-target="#updateModal" class="btn btn-info">Cập Nhật</button>
                                        <button v-on:click="phim_xoa = value" class="btn btn-danger"
                                            data-bs-toggle="modal" data-bs-target="#xoaModal">Xóa Phim</button>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button v-on:click="xoaPhimTrenServer()" type="button"
                                                class="btn btn-danger" data-bs-dismiss="modal">Xóa Phim</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="modal fade" id="hinhAnhModel" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="text-center">
                                                <img v-bind:src="phim_xoa.avatar" class="img-fluid"
                            ...
                            <div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <input v-model="phim_update.id" type="hidden" name=""
                                                id="">
                                            <div class="form-group mt-3">
                                                <label>Tên Phim</label>
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <input v-model="phim_update.ngay_khoi_chieu" type="date"
                                                    class="form-control" placeholder="Nhập vào tên phim">
                                            </div>
                                            <div class="form-group mt-3">
                                                <label>Đạo Diễn</label>
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <input v-model="phim_update.thoi_luong" type="number"
                                                    class="form-control" placeholder="Nhập vào phút">
                                            </div>
                                            <div class="form-group mt-3">
                                                <label>Mô Tả</label>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button v-on:click="capNhatPhimServer()" type="button"
