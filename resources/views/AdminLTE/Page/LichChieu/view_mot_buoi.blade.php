...
@section('noi_dung')
    <div class="row" id="app">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollablev modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Thêm Mới Lịch Chiếu</h1>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <select v-on:change="updateThoiGian()" v-model="create_lich.id_phim_xxx"
                                                class="form-control">
                                                <template v-for="(value, key) in list_phim" v-if="value.tinh_trang > 0">
                                                    <option
                                                        v-bind:value="{id_phim : value.id, thoi_luong: value.thoi_luong}">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input v-model="create_lich.thoi_gian_chieu_chinh" type="number" min="0"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Thời Lượng Quảng Cáo</label>
                                            <input v-model="create_lich.thoi_gian_quang_cao" type="number" min="0"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="button" v-on:click="themLichChieu()">Thêm Mới Lịch
                            Chiếu</button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6"><b class="fs-4">Danh Sách Lịch Chiếu</b></div>
                        <div class="col-md-6 text-end">
                            <button type="button" class="btn btn-primary w-5" data-bs-toggle="modal"
                            ...
                            <tbody>
                                <tr v-for="(v, k) in list_lich">
                                    ...
                                    <td class="text-center">
                                        <button v-on:click="layDataGhePhong(v)" class="btn btn-primary mr-1"
                                            data-bs-toggle="modal" data-bs-target="#gheModal">Xem Ghế</button>
                                        <button v-on:click="deleteLich(v)" class="btn btn-danger mr-1"
                                            data-bs-toggle="modal" data-bs-target="#deleteModal">Xóa Lịch</button>
                                        <button v-on:click="editLich(v)" class="btn btn-info" data-bs-toggle="modal"
                                            data-bs-target="#updateModal">Cập Nhật Lịch</button>
                                    </td>
                                </tr>
                            </tbody>
                            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Bạn có muốn xóa lịch chiếu phim <b
                                                    class="text-danger">@{{ delete_lich.ten_phim }}</b>
                                                tại phòng <b class="text-danger">@{{ delete_lich.ten_phong }}</b> này không?</p>
                                            <p>Thời gian chiếu dự kiến từ @{{ delete_lich.thoi_gian_bat_dau }} đến @{{ delete_lich.thoi_gian_ket_thuc }}
                                            </p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button v-on:click="xoaLichChieu()" type="button" class="btn btn-primary"
                                                data-bs-dismiss="modal">Xóa Lịch</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label class="form-label">Chọn Phim</label>
                                                    <select v-on:change="updateThoiGian()" v-model="update_lich.id_phim"
                                                        class="form-control">
                                                        <template v-for="(value, key) in list_phim"
                                                            v-if="value.tinh_trang > 0">
                                                            <option v-bind:value="value.id">@{{ value.ten_phim }}
                                                            </option>
                                                        </template>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label">Thời Lượng Chiếu Chính</label>
                                                    <input v-model="update_lich.thoi_gian_chieu_chinh" type="number"
                                                        min="0" class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label">Thời Lượng Quảng Cáo</label>
                                                    <input v-model="update_lich.thoi_gian_quang_cao" type="number"
                                                        min="0" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="col-md-3">
                                                    <label class="form-label">Ngày Chiếu Phim</label>
                                                    <input v-model="update_lich.ngay_chieu" type="date"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label">Giờ Bắt Đầu</label>
                                                    <input v-model="update_lich.gio_bat_dau" type="time"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label">Giờ Kết Thúc</label>
                                                    <input v-model="update_lich.gio_ket_thuc" type="time"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label">Phòng Chiếu Phim</label>
                                                    <select v-model="update_lich.id_phong" class="form-control">
                                                        <template v-for="(value, key) in list_phong"
                                                            v-if="value.tinh_trang == 1">
                                                            <option v-bind:value="value.id">@{{ value.ten_phong }}
                                                            </option>
                                                        </template>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button v-on:click="capNhatLichChieu()" type="button"
                                                class="btn btn-primary" data-bs-dismiss="modal">Cập Nhật Lịch</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered">
                                                <tr class="border border-dark" v-for="i in (0, tt_phong.hang_ngang)">
                                                    <template v-for="j in (0, tt_phong.hang_doc)">
                                                        <td v-on:click="doiTrangThaiGhe(ds_ghe[(i - 1) * tt_phong.hang_doc +  j - 1])"
                                                            v-if="ds_ghe[(i - 1) * tt_phong.hang_doc +  j - 1].co_the_ban == 1"
                                                            style="background-color: #e6e7e9"
                                                            class="text-center border-dark align-middle">
                                                            @{{ ds_ghe[(i - 1) * tt_phong.hang_doc + j - 1].ten_ghe }}
                                                        </td>
                                                        <td v-on:click="doiTrangThaiGhe(ds_ghe[(i - 1) * tt_phong.hang_doc +  j - 1])"
                                                            v-else class="bg-danger text-center border-dark align-middle text-white">
                                                            @{{ ds_ghe[(i - 1) * tt_phong.hang_doc + j - 1].ten_ghe }}
                                                        </td>
                                                    </template>
                                                </tr>
